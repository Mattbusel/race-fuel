"""Race Fuel Pro: the one in-app purchase, and the switch from paid to free.
...
PRODUCT_ID = "com.mattbusel.racefuel.pro"
NAME = "Race Fuel Pro"
PRICE = "4.99"
DESCRIPTION = "Race clock, intake reminders, all products, sharing."  # 55 chars max
REVIEW_NOTE = (
    "Non-consumable, one-time unlock. The app is free; the sweat test, hourly targets, every race "
    "preset, Auto-fill, the timeline and the shopping list are free forever. Pro unlocks race day "
    "(the Start the race button: the race clock plus a local notification for every intake), more "
    "than 3 products of the user's own on top of the 12 starter products, and sharing the plan as "
    "text. To see the paywall: open the Timeline tab and tap Start the race, or tap Share the plan "
    "on the same tab. Restore purchase is on the paywall and on the Race Fuel Pro card at the bottom "
    "of the Athlete tab."
)
